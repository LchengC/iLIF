...
All training commands are listed in [parameter.py](https://github.com/LchengC/iLIF/parameter.py). For example, you can run the following commands to train iLIF on the EventStoryLine v0.9 datasets.
